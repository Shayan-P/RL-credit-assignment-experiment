...
from data.convertor import ReshapeStateConvertor, RewardConvertor, DiscreteActionConvertor


class UmbrellaLengthDataset(TrajectoryDataset):
    def __init__(self, env: gym.Env, n_trajectories=10000, reward_scale=None):
        ...
        for observations, actions, rewards, returns, dones in self.trajectories:
            all_state_features.extend(observations)
        ...
        self._state_convertor = ReshapeStateConvertor(self.env.observation_space, (self.env.observation_space.shape[1],))
